...
var _setUaBodyClass = require('./util/setUaBodyClass');

var _setUaBodyClass2 = _interopRequireDefault(_setUaBodyClass);
...
(0, _jquery2.default)(function () {
  ...
  // VARIABLES
  var $container = (0, _jquery2.default)(".instagram_container");
  var html = "";
  ...
  (0, _jquery2.default)(window).on('resize', function () {
    windowWidth = (0, _jquery2.default)(window).innerWidth();
    windowHeight = (0, _jquery2.default)(window).innerHeight();
    desktopInstagramSize = windowWidth / 5;
    mobileInstagramSize = windowWidth / 3;
  });
  ...
  // A LINK ANCHOR
  (0, _jquery2.default)("a[href^='#']:not('.popup')").on('click', function () {
    var speed = 500,
        href = (0, _jquery2.default)(this).attr("href"),
        target = (0, _jquery2.default)(href == "#" || href == "" ? 'html' : href),
  ...
  // MENU BUTTON TOGGLE
  (0, _jquery2.default)(".btn_open").on('click', function () {
    if (!(0, _jquery2.default)(".header").hasClass('is-open')) {
      (0, _jquery2.default)(".header").addClass('is-open');
      setTimeout(function () {
        (0, _jquery2.default)(".header").addClass('is-bg-show');
      }, 600);
      (0, _jquery2.default)(".nav > ul > li").each(function (index, item) {
        setTimeout(function () {
          (0, _jquery2.default)(item).addClass('is-show');
        }, 200 + 100 * index);
      });
    } else {
      (0, _jquery2.default)(".nav > ul > li").each(function (index, item) {
        setTimeout(function () {
          (0, _jquery2.default)(item).removeClass('is-show');
        }, 200 + 100 * index);
      });
      setTimeout(function () {
        (0, _jquery2.default)(".header").removeClass('is-bg-show');
        setTimeout(function () {
...
},{"./_map":6,"./util/setUaBodyClass":7,"animejs":1,"aos":2,"in-view":3,"jquery":4}],6:[function(require,module,exports){
/**
...
module.exports = function () {
  ...
  function init() {
    var mapOptions1 = {
      zoom: (0, _jquery2.default)(window).innerWidth() > 768 ? 18 : 16,
      scrollwheel: false,
...
var _whichUserAgent = require('./whichUserAgent.js');

var _whichUserAgent2 = _interopRequireDefault(_whichUserAgent);

var _whichMobile = require('./whichMobile.js');

var _whichMobile2 = _interopRequireDefault(_whichMobile);
...
module.exports = function () {
  ...
  var ua = (0, _whichUserAgent2.default)();
  if (ua.ie6) {
    $body.addClass('ua-ie6');
  } else if (ua.ie7) {
    $body.addClass('ua-ie');
  } else if (ua.ie8) {
    $body.addClass('ua-ie');
  ...
  var mobile = (0, _whichMobile2.default)();
  if (mobile.iPhone) {
    $body.addClass('mobile-iPhone');
  } else if (mobile.iPod) {
    $body.addClass('mobile-iPod');
  } else if (mobile.iPad) {
...
},{"./whichMobile.js":8,"./whichUserAgent.js":9,"jquery":4}],8:[function(require,module,exports){
'use strict';
...
module.exports = function () {
  ...
  ret.ie = function () {
    return ret.ie6 || ret.ie7 || ret.ie8 || ret.ie9 || ret.ie10;
  }();
